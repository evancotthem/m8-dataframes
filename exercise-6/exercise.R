...
setwd("~/Documents/UW/Info 201/m8-dataframes/exercise-6")
...
MostPopular <- function(my.year) {
  ...
  most.pop.name <- names.year[prop.year == max(prop.year)]
  return(paste("The most popular name of", my.year, "was", most.pop.name))
}
