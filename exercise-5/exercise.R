...
setwd("~/Documents/UW/Info 201/m8-dataframes/exercise-5")
...
org.largest.grant <- grants[spending == largest.grant, "organization"]

# Which organization received the smallest grant?
org.smallest.grant <- grants[spending == smallest.grant, "organization"]
